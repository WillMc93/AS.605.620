...
python3 project2.py ./inputs/class_input.txt ./outputs/output8.out class 120 3 quadratic [0.5,0.5]
...
python3 project2.py ./inputs/student_input.txt ./outputs/student_output8.out class 120 3 quadratic [0.5,0.5]
...
python3 project2.py ./inputs/class_input.txt ./outputs/output8_c1.out class 120 3 quadratic [0,1]
python3 project2.py ./inputs/class_input.txt ./outputs/output8_c2.out class 120 3 quadratic [1,0]
